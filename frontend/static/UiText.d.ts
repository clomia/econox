...
export interface UiText {
    ...
    ElementLoadingInfo: "Loading saved elements..." | "저장된 요소들을 불러오는 중입니다...";
    ...
    f_ChartLoadingInfo: "Collecting data on {factor} related to {element}..." | "{element}에 대한 {factor} 데이터를 수집중입니다...";
